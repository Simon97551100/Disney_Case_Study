...
plt.plot(n_estimators_range, train_accuracies, label='Train R-squared (R2)')
...
plt.figure(figsize=(10, 6))
plt.plot(n_estimators_range, test_accuracies, label='Test R-squared (R2)',color='orange')
plt.xlabel('Number of Estimators')
plt.ylabel('R-squared (R2) Score')
...
plt.plot(y_test, y_pred_reg_mae, color='green', linewidth=2)
...
plt.plot(y_test, y_pred_reg_mse, color='green', linewidth=2)
st.pyplot(plt)
